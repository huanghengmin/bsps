       ...
       /* defaults:{
        ...
        items:[
           ...
           /* {
                border: false,
                xtype:'displayfield',
                value:'<p align="center" style="font-size:15;font-family:楷体_GB2312;font-weight:bolder;">BS服务运行状态</p><br/>'
//                bodyStyle: 'background:none;',
//                html: '<p align="center" style="font-size:15;font-family:楷体_GB2312;font-weight:bolder;">BS服务运行状态</p><br/> '
            },*/
...
//-----------------------------------------------------------------------------------------------证书配置---------------------------------------------------------------------------------------------------------
    ...
    /* var cccsm = new Ext.grid.CheckboxSelectionModel();
     ...
     url : '../../NginxServerStatusAction_findCaConfig.action'
...
function chongqi() {
    Model.reloadServe();
//    Ext.Ajax.request({
//        url:'../../NginxServerStatusAction_reloadServe.action',
//        success:function (response, result) {
