...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/server/manager_bsps.js"></script>
</head>
...
<head>
    <title>服务参数配置</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/server/manager_params.js"></script>
</head>
