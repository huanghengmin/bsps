...
<html version="-//W3C//DTD HTML 4.01 Transitional//EN">
    <head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/server/manager_fwqjrpz.js"></script>
    </head>
...
<head>
    <title>服务器接入配置</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bs/manager_fwqjrpz.js"></script>
</head>
